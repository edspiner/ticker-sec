...
exports.flip=!1?function(from,to,direction,duration,finishCallback){var
vertical=direction===exports.VERTICAL,
flipped_matrix=Ti.UI.create3DMatrix().rotate(-90,vertical?1:0,vertical?0:1,0),
from_animation=Ti.UI.createAnimation({
transform:flipped_matrix,
duration:duration});

to.transform=flipped_matrix,
from.animate(from_animation,function(){var
unflipped_matrix=Ti.UI.create3DMatrix().rotate(0,vertical?1:0,vertical?0:1,0),
to_animation=Ti.UI.createAnimation({
...
return view.transform=Ti.UI.create2DMatrix(),void(view.opacity=1);var


animate1=Ti.UI.createAnimation({
opacity:1,
...
exports.shake=function(view,delay,finishCallback){var
shake1=Ti.UI.createAnimation({
...
exports.flash=function(view,delay,finishCallback){var
flash1=Ti.UI.createAnimation({
opacity:.7,
duration:100}),
...
return view=animations=null,void(finishCallback&&finishCallback());
