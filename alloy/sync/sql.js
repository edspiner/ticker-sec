...
for(var values=[],fieldNames=[],fieldCount=_.isFunction(rs.fieldCount)?rs.fieldCount():rs.fieldCount,getField=0?rs.field:rs.field.bind(rs),i=0;i<fieldCount;i++)
...
!1===config.adapter.remoteBackup;var
